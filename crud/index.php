...
<body>
  <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: #87ceeb; font-family:Arial, Helvetica, sans-serif;">
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td>
              <img src="uploads/<?php echo $row["profile_image"]; ?>" alt="Profile Image" style="width: 50px; height: 50px; object-fit: cover;">
            </td>
            <td>
               <a href="edit.php?id=<?php echo $row["rfid_uid"] ?>" class="link-dark"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
               <a href="#" onclick="confirmDelete('delete.php?id=<?php echo $row["rfid_uid"] ?>'); return false;" class="link-dark"><i class="fa-solid fa-trash fs-5"></i></a>
             </td>
