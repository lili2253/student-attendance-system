...
<body>
    <div class="main">
        ...
        <div class="content">
            <h1>Welcome from<br><span>DoorLock System</span><br></h1>
            <p class="par">This doorlock system is to check all of the students in campus area</p>
            <a href="AD_doorlock.php"><button class="cn">View</button></a>
        </div>
    </div>
